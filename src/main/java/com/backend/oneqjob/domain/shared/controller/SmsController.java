package com.backend.oneqjob.domain.shared.controller;
...
import com.backend.oneqjob.global.api.ApiResponse;
...
public class SmsController {
    ...
    @PostMapping("/sendOtp")
    public ResponseEntity<ApiResponse> sendOtp(@RequestBody OtpRequest otpRequest, HttpSession httpSession) {
        ...
        try {
            ...
            ApiResponse apiResponse = new ApiResponse(true, "OTP code was successfully sent.", responseData);
            return ResponseEntity.ok(apiResponse);
        } catch (Exception e) {
            ApiResponse apiResponse = new ApiResponse(false, "Failed to send OTP.");
